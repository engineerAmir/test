...
<footer class="site-footer" id="contact">
    <div class="container footer-grid">
        <div><a class="brand brand-light" href="<?php echo esc_url( home_url( '/' ) ); ?>"><span class="brand-mark">ح</span><span class="brand-name">حقول السلام<small>حلول تنمو معك</small></span></a><p class="footer-intro">حقول السلام — حلول متكاملة للشتلات والحدائق والمشاريع الزراعية.</p></div>
